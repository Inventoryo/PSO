...
cove_rate_PSO_V1=load('D:/Workspace/PSO/地图层数30次数据20230219/0/0/cove_rate_PSO.txt'); 
...
%  cove_rate_PSO_V1=load('../地图层数30次数据20230219/最终实验数据/search_performance/1102_6V0_PSO/cove_rate_PSO.txt');
%  cove_rate_PSO_V2=load('../地图层数30次数据20230219/最终实验数据/search_performance/0505_6V0_PIO/cove_rate_PSO.txt');
%  cove_rate_PSO_V3=load('../地图层数30次数据20230219/最终实验数据/search_performance/1102_6V0_BottomUp/cove_rate_PSO.txt'); 
%  cove_rate_PSO_V4=load('../地图层数30次数据20230219/最终实验数据/search_performance/1102_6V0_TopDown/cove_rate_PSO.txt'); 
%  cove_rate_PSO_V5=load('../地图层数30次数据20230219/0506_6V0_PIO_效果好/cove_rate_PSO.txt'); 
%  cove_rate_PSO_V6=load('../地图层数30次数据20230219/最终实验数据/search_performance/1102_6V0_ACO/cove_rate_PSO.txt'); 
%  cove_rate_PSO_V7=load('../地图层数30次数据20230219/1007_9V0_layer7/cove_rate_PSO.txt'); 
