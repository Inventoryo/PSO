...
%  L1=load('./mingw_build/draw_data/L1/1/destroyed_target_num.txt');
%  L2=load('./mingw_build/draw_data/L2/3/destroyed_target_num.txt'); 
%  L3=load('./mingw_build/draw_data/L3/1/destroyed_target_num.txt'); 
%  L4=load('./mingw_build/draw_data/L4/3/destroyed_target_num.txt'); 
 L5=load('./mingw_build/draw_data/L5/1/destroyed_target_num.txt'); 
 L6=load('./mingw_build/draw_data/L6/6/destroyed_target_num.txt'); 
 L7=load('./mingw_build/draw_data/L7/12/destroyed_target_num.csv'); 
x_idx = 1:1500;
figure(1);
first_row = 1;
last_row  = 1500;
